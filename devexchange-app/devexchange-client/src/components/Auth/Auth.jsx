...
const Auth = () => {
    ...
    const handleSubmit = (e) => {
        ...
        // Email validation to allow only @srmist.edu.in
        const emailDomain = "@srmist.edu.in";
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <label htmlFor="password">
                        ...
                        {isSignUp && (
                            <p className="text-item">
                                Passwords must contain at least 8 characters, including one letter
                                and one digit
                            </p>
                        )}
                    </label>
                    ...
                    {isSignUp && (
                        <label htmlFor="check">
                            ...
                            <p className="text-item">
                                Opt in to receive occasional, <br /> promotional and product
                                information
                            </p>
                        </label>
                    )}
